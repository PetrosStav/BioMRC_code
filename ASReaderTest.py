...
odir = 'drive/My Drive/BioGroup/ASReaderTest/bioread_pn/{}/'.format(od)
...
if resume_from == 0:
    ...
    resume_from = 'drive/My Drive/BioGroup/ASReaderTest/bioread_pn/bioread_without_pn_asreader/checkpoint_small.pth.tar'
elif resume_from == 2:
    resume_from = 'drive/My Drive/BioGroup/ASReaderTest/bioread_pn/bioread_without_pn_asreader/best_checkpoint_small.pth.tar'
...
def train_one_epoch(epoch):
    ...
    for b_context, b_quest, b_candidates, b_target in data_yielder(0):
        m_batches += 1
        optimizer.zero_grad()
